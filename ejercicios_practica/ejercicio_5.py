...
if __name__ == '__main__':
    ...
    # personal_1_10 = [.....]
    personal_1_10 = [x for x in accesos if 0<x<=10]
    print("De los acceos", accesos, "solo ingresaron los ID's", personal_1_10)
    # 2)
    ...
    print("El personal permitido actualmete es el que cuente con el ID", personal_valido)
